...
description: Aegis materials library — presets, composition editor (at%), validation, material.json recipes. Use when changing materials API, presets, or composition UI.
---
...
- Editor supports at%; normalize/validate before save.
